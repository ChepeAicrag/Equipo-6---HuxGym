      ...
      .then((res) => {
        ...
        if (res.data.message !== "Filtrado por edad") {
          this.setState({
            ...
            tipo: "Asistencia según el género",
          });
        } else {
          this.setState({
            data: res.data.total,
    ...
    return (
      <>
        ...
        <div className="SelectorWrapperAsistencia">
          <label className="Texto mt-3 mr-2 ml-2">Filtro</label>
          <div className="SelectorP mt-3 mr-2 ml-2">
            <select
              className="Opciones"
              class="form-select"
          ...
          <label className="Texto mt-3 mr-2 ml-2">Estudiante</label>
          <ToggleButton
            className="mt-3 mr-2 ml-2"
            inactiveLabel={"No"}
            activeLabel={"Si"}
            value={this.state.estudiante}
            onToggle={this.handleEstudiante}
          />
